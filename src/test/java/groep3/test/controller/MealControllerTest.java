...
public class MealControllerTest {
    ...
    void shouldPostMeal() throws Exception {
        ...
        postMeal.ID = 1;
        postMeal.name = "Wortelsoep";
        postMeal.image = "https://weckenonline.eu/wp-content/uploads/2015/12/Wortelsoep-1.jpg";
        postMeal.price = 4.99;
    ...
    void shouldUpdateMealById() throws Exception
    {
        ...
        putMeal.ID = 1;
        putMeal.name = "Wortelsoep met extra groente";
        putMeal.image = "https://weckenonline.eu/wp-content/uploads/2015/12/Wortelsoep-1.jpg";
        putMeal.price = 5.99;
