...
public class MenuServiceApplication {
	...
	/**
	 ...
	 INSERT INTO `groep3`.`meal` (`meal_id`, `category_id`, `img_src`, `meal_name`, `meal_price`) VALUES ('2', '2', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPv6sZreFCdD81Vd3ER9546MxgIxRuTBnspQ&usqp=CAU', 'Friet', '2.99');
	 ...
	 INSERT INTO `groep3`.`meal` (`meal_id`, `category_id`, `img_src`, `meal_name`, `meal_price`) VALUES ('6', '3', 'https://img.itdg.com.br/tdg/images/blog/uploads/2017/10/shutterstock_236136835.jpg?w=1200', 'Red Velvet Cake', '4.99');
	 INSERT INTO `groep3`.`meal` (`meal_id`, `category_id`, `img_src`, `meal_name`, `meal_price`) VALUES ('7', '5', 'https://static.ah.nl/static/gall/img_54694_Gall_500.png', 'Jack Daniël\'s Fles', '44.99');
