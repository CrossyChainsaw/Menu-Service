	...
	INSERT INTO meal (meal_id, category_id, img_src, meal_name, meal_price) VALUES
      ...
      ('2', '2', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPv6sZreFCdD81Vd3ER9546MxgIxRuTBnspQ&usqp=CAU', 'Friet', '2.99'),
	...
	INSERT INTO drink (drink_id, category_id, drink_name, drink_price, img_src) VALUES
      ('1', '4', 'Coca Cola Blikje', '2.49', 'https://www.shinzo.nl/wp-content/uploads/2020/05/cocacola.png');
